...
public class ListItemDistrictListBindingLandImpl extends ListItemDistrictListBinding  {
    ...
    public ListItemDistrictListBindingLandImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }
    private ListItemDistrictListBindingLandImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        java.lang.String stringValueOfMDistrictWiseDeceased = null;
        int mDistrictWiseConfirmed = 0;
        java.lang.String stringValueOfMDistrictWiseConfirmed = null;
        java.lang.String stringValueOfMDistrictWiseActive = null;
        java.lang.String mDistrictWiseDistrictName = null;
        int mDistrictWiseDeceased = 0;
        com.mohann.covid19.room.model.DistrictWiseModel mDistrictWise = mMDistrictWise;
        int mDistrictWiseRecovered = 0;
        java.lang.String stringValueOfMDistrictWiseRecovered = null;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
                ...
                // read String.valueOf(mDistrictWise.active)
                stringValueOfMDistrictWiseActive = java.lang.String.valueOf(mDistrictWiseActive);
                // read String.valueOf(mDistrictWise.confirmed)
                stringValueOfMDistrictWiseConfirmed = java.lang.String.valueOf(mDistrictWiseConfirmed);
                // read String.valueOf(mDistrictWise.deceased)
                stringValueOfMDistrictWiseDeceased = java.lang.String.valueOf(mDistrictWiseDeceased);
                // read String.valueOf(mDistrictWise.recovered)
                stringValueOfMDistrictWiseRecovered = java.lang.String.valueOf(mDistrictWiseRecovered);
        }
        // batch finished
        if ((dirtyFlags & 0x3L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tvActive, stringValueOfMDistrictWiseActive);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tvConfirmed, stringValueOfMDistrictWiseConfirmed);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tvDeceased, stringValueOfMDistrictWiseDeceased);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tvRecovered, stringValueOfMDistrictWiseRecovered);
