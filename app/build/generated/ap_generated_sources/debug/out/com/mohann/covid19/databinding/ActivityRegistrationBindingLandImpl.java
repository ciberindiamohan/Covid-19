...
public class ActivityRegistrationBindingLandImpl extends ActivityRegistrationBinding implements com.mohann.covid19.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.clRegister, 8);
        sViewsWithIds.put(R.id.guideLine, 9);
        sViewsWithIds.put(R.id.guideLineOne, 10);
        sViewsWithIds.put(R.id.guideLineTwo, 11);
    }
    // views
    @NonNull
    ...
    public ActivityRegistrationBindingLandImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }
    private ActivityRegistrationBindingLandImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
